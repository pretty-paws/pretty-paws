...
export class CategoryStore {
  constructor() {
    ...
    this._categories = [
      ...
      {
        id: 2,
        title: 'Гігієна для дому котиків',
      ...
      {
        id: 4,
        title: 'Інструменти по догляду котиків',
        description: 'Інструменти по догляду',
        category_animal_id: 2,
      },
      {
        id: 5,
        title: 'Подорож та відпочинок котиків',
      ...
      {
        id: 11,
        title: 'Подорож та відпочинок песиків',
        description: 'Подорож та відпочинок',
        category_animal_id: 1,
      },
      {
      ...
      {
        id: 16,
        title: 'Подорож та відпочинок гризунів',
        description: 'Подорож та відпочинок',
        category_animal_id: 3,
      },
      {
        id: 17,
        title: 'Клітки та аксесуари для гризунів',
      ...
      {
        id: 19,
        title: 'Обладнання акваріумів рибок',
        description: 'Обладнання акваріумів',
        category_animal_id: 4,
      },
      {
        id: 20,
        title: 'Грунт та декорації для рибок',
      ...
      {
        id: 23,
        title: 'Харчування птахів',
        description: 'Харчування птахів',
        category_animal_id: 5,
      },
      {
        id: 24,
        title: 'Клітки та аксесуари для птахів',
        description: 'Клітки та аксесуари',
        category_animal_id: 5,
      },
      {
        id: 25,
        title: 'Здоров’я та лікування птахів',
        description: 'Здоров’я та лікування',
        category_animal_id: 5,
      },
      {
        id: 26,
        title: 'Догляд та гігієна птахів',
        description: 'Догляд та гігієна птахів',
        category_animal_id: 5,
      },
      {
        id: 27,
        title: 'Подорожі та відпочинок з птахами',
        description: 'Подорожі та відпочинок',
        category_animal_id: 5,
      },
      {
        id: 28,
        title: 'Товари для диких птахів',
        description: 'Товари для диких птахів',
        category_animal_id: 5,
      },
      {
        id: 29,
        title: 'Харчування рептилій',
        description: 'Харчування рептилій',
        category_animal_id: 6,
      },

      {
        id: 30,
        title: 'Тераріуми та аксесуари для рептилій',
        description: 'Тераріуми та аксесуари',
        category_animal_id: 6,
      },
      {
        id: 31,
        title: 'Здоров’я та лікування рептилій',
        description: 'Здоров’я та лікування',
        category_animal_id: 6,
      },
      {
        id: 32,
        title: 'Обладнання для тераріумів рептилій',
        description: 'Обладнання для тераріумів',
        category_animal_id: 6,
      },
      {
        id: 33,
        title: 'Догляд та гігієна рептилій',
        description: 'Догляд та гігієна',
        category_animal_id: 6,
      },
